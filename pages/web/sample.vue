<script setup>
	...
	const onTogglePassword = () => {
		isShowPassword.value =
			isShowPassword.value === 'password' ? 'text' : 'password';
	};
...
<template>
	<div>
		...
		<div>
			<BaseTextarea rows="4" v-model="formLogin.snackRequest" placeholder="Snack remarks" :error="isError"
				errorType="danger" errorMessage="Input your request, max 100 character" />
		</div>
		<div>
